...
public final class LiteJobConfiguration implements JobRootConfiguration {
    ...
    public static class Builder {
        ...
        public final LiteJobConfiguration build() {
            return new LiteJobConfiguration(jobConfig, monitorExecution, 
            		maxTimeDiffSeconds, monitorPort, 
            		jobShardingStrategyClass, reconcileIntervalMinutes, 
            		disabled, overwrite,jobGroup);
        }
